...
# Define directories
evaluation_dir = "/Users/mateodib/Desktop/Environmental_News_Checker-Mateo/Evaluation_results_parsed/"
article_dir = "/Users/mateodib/Desktop/Environmental_News_Checker-Mateo/Articles_presse/"
output_dir = "/Users/mateodib/Desktop/Environmental_News_Checker-Mateo/Resultats_JSON/"
...
for filename in os.listdir(evaluation_dir):
    if filename.endswith("_parsed.csv"):
        ...
        article_filename = filename.replace("_parsed.csv", "_climate_analysis_results.csv")
